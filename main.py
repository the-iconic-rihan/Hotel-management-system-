...
class Restaurant:
    ...
    def drinks(self, user_drink, size):
    ...
    def breakfast(self, user_breakfast, size):
    ...
    def veg_food(self, user_veg, size):
    ...
    def non_veg_food(self, user_non_veg, size):
    ...
    def non_veg_breakfast(self, user_non_veg, size):
    ...
    def non_veg_cocktail(self, user_non_veg, size):
...
def main():
    ...
    print("Do You want to enter in admin cell? yes 0r no !")
    admin_cell = (input())
    ...
    if admin_cell == "yes":
        ...
        time.sleep(2)
        if password == 4562 and username == "rb":
            print("Welcome to amin cell!")
            print("\n\t 1] clear all record of invoice \n\t2]Exit of admin cell")
            admin_choice = int(input())
            if admin_choice == 1:
                clear_invoice()
            elif admin_choice == 2:
                print("You logout from admin cell..")
                main()
        else:
            print("You entered incorrect credentials")
            main()
    else:
...
if __name__ == '__main__':
    ...
    def _drinks_order():
        ...
        with open("invoice.txt", "a+") as f:
            ...
            string += str("\t\n") + str(
                f"Drinks ordered : - {user_drink} * {size} = {Drinks[user_drink]}/drink.")
            string += str("\t\n") + str(f"Total amount:- {hotel_customer.initial_bill}")
            string += str("\n") + str("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
            f.write(string)
        hotel_customer.drinks(user_drink, size)
    ...
    def _breakfast_order():
        ...
        hotel_customer.breakfast(user_breakfast, size)
    ...
    def _dishes_order():
        ...
        with open("invoice.txt", "a+") as f:
            string = str(" ")
            string += str("\n\t") + str(
                "~~~~~~~~~~~~~~~~~~~~~~~~~~Invoice for veg_dishes~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
            string += str("\t\n") + str(f"Invoice for {customer_name}'s order.")
            string += str("\t\n") + str(
                f"Drinks ordered : - {user_veg} * {size} = {veg_food[user_veg]}/dish.")
            string += str("\t\n") + str(f"Total amount:- {hotel_customer.initial_bill}")
            string += str("\n") + str("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
            f.write(string)
        hotel_customer.veg_food(user_veg, size)
    ...
    def _cocktails_order():
        ...
        with open("invoice.txt", "a+") as f:
            string = str(" ")
            string += str("\n\t") + str(
                "~~~~~~~~~~~~~~~~~~~~~~~~~~Invoice for cocktails~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
            string += str("\t\n") + str(f"Invoice for {customer_name}'s order.")
            string += str("\t\n") + str(
                f"Drinks ordered : - {user_non_veg} * {size} = {cocktails[user_non_veg]}/dish.")
            string += str("\t\n") + str(f"Total amount:- {hotel_customer.initial_bill}")
            string += str("\n") + str("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
            f.write(string)
        hotel_customer.non_veg_cocktail(user_non_veg, size)
    ...
    def _non_veg_breakfast_order():
        ...
        with open("invoice.txt", "a+") as f:
            string = str(" ")
            string += str("\n\t") + str(
                "~~~~~~~~~~~~~~~~~~~~~~~~~~Invoice for non_veg_breakfast~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
            string += str("\t\n") + str(f"Invoice for {customer_name}'s order.")
            string += str("\t\n") + str(
                f"Drinks ordered : - {user_non_veg} * {size} = {non_veg_breakfast[user_non_veg]}/dish.")
            string += str("\t\n") + str(f"Total amount:- {hotel_customer.initial_bill}")
            string += str("\n") + str("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
            f.write(string)
        hotel_customer.non_veg_breakfast(user_non_veg, size)
    ...
    def _non_veg_dishes_order():
        ...
        with open("invoice.txt", "a+") as f:
            ...
            string += str("\n") + str("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
            f.write(string)
        hotel_customer.non_veg_food(user_non_veg, size)
